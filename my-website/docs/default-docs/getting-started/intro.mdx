...
Ready to build something? Head to the [installation guide](/installation) to get Refract set up in your project, then walk through [your first component](/create-your-first-component) to see how everything fits together.
