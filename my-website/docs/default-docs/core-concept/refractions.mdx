...
Refractions handle your data, but to organize and reuse stateful logic across components, you'll want to learn about lenses—the system that provides controlled access to refractions and side effects within your components.
