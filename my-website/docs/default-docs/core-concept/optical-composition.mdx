...
Optical composition gives you the power to create reusable, testable logic that can be shared across your entire application. The final piece of the puzzle is understanding [side effects](/side-effects) how to handle things like animations, timers, and external integrations safely within the Refract ecosystem.