...
That's everything you need to know about managing state with refractions. Next, check out [useOptic](/docs/use-optic) to learn about creating reusable logic patterns.