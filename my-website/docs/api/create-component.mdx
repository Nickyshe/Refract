...
That's everything you need to know about creating components in Refract. Next, learn about [useRefraction](/docs/use-refraction) to manage state in your components.