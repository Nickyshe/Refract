...
Ready to build something? Head to the [installation guide](./installation.mdx) to get Refract set up in your project, then walk through [your first component](./create-your-first-component.mdx) to see how everything fits together.
